        ...
        <div class="row">
            ...
            <div class="col-md-2 d-none d-sm-block">
                <ul class="list-group mb-3">
                    ...
                    <li class="list-group-item d-flex justify-content-between lh-condensed">
                        <svg class="bd-placeholder-img mr-2 rounded" width="32" height="22"
                ...
                <a href='../home.php'><button type="button"
                        class="btn btn-sm btn-outline-success btn-block">FINALIZAR</button></a>
            </div>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="formedit">
                                ...
                                <form id="editevent" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="custom-select" name="title">
                                                <option value='<?php echo $_SESSION['nome']; ?>'>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-10">
                                            <button type="button" class="btn btn-danger btn-canc-edit"
                ...
                <div class="modal-dialog modal-lg modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <p class=text-justify>Ao escolher as datas para realizar os plantões extraordinários, o
